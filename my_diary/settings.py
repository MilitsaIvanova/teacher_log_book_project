...
SECRET_KEY = 'django-insecure-viao9cbfgt(kq5ns61u1z1(+*8fbzdhjs%kp9s^f$d!lb)iek*'
...
MIDDLEWARE = [
    ...
    'my_diary.custom_middleware.AdminAccessMiddleware',
]
...
AUTH_USER_MODEL='account_app.DiaryUser'
